...
public class ExampleGoogleLoginActivity extends AppCompatActivity implements  GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_example_google_login);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AuthenticationBaseCode.createAccountWithEmailAndPassword("dr2pvms@gmail.com","kill/dill",ExampleGoogleLoginActivity.this) ;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ExampleGoogleLoginActivity.this, "Authentication failed.",
        ...
        Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(
                new ResultCallback<Status>() {
                    ...
                    public void onResult(Status status) {
                        Toast.makeText(ExampleGoogleLoginActivity.this, "Sign Out is Successufl", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    // Here onWords it is PhoneNumberVerification
    /*
